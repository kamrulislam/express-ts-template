...
class Connection {
  ...
  static init () {
    ...
    log.info('DbConnection.init POSTGRES_HOST: %s, POSTGRES_PORT: %s,  POSTGRES_SSL: %s',
    ...
    log.info('DbConnection.init created db with CON: %j, process.env.NODE_ENV: %s', CON, process.env.NODE_ENV);
  }
